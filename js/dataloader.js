		...
		for (var i = 0; i < data.length; i++) {
			for (var j = 0; j < yComponent.length; j++)
			{
				...
				if (xComponent == "ha_clade")
				{
					...
					var h3clade = ['cluster_IV','cluster_IVA','cluster_IVB','cluster_IVE','cluster_IVF','cluster_IVD','cluster_IVC','2010-human-like','human-to-swine-2016','human-to-swine-2017'];
