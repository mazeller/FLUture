...
<h2 id="chartTitle">Flu Cases per Year</h2>
...
<h2 style="color:#c00">Suite of Tools</h2>
<p>
...
<h2 style="color:#c00">Variables</h2>
<p>
The IS<sub>Flu</sub>View database curates information related to the individual swine cases. An explanation of each of the variables that IS<sub>Flu</sub> allows searching for can be found below.<br/><br/>
...
The phylogenetic clade that a flu positive sample is part of, based on the hemagluttinin sequence. Currently the IS<sub>Flu</sub>View database tracks only H1 and H3 subtype hemagluttanin, thus clades will be derived from one of these subtypes.<br/>

<strong>HA Sequence</strong><br/>
The genetic sequence of the hemagluttanin of a specific influenza virus case. Sequencing is only attempted for sample with cycle threshold (CT) values less then or equal to 38.<br/>
...
The specimen from which the subtyping PCR was derived from.<br/>
...
The subtype of the influenza virus, based on PCR identificatin of the hemagluttinin and neuraminidase proteins.<br/>
