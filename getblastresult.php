...
if($blast_type == "aa")
{
        $result = shell_exec("/opt/ncbi-blast-2.7.1+/bin/blastp -query " . $path . " -db /var/www/BLASTdb2/vdl_flu_aa -outfmt \"6 sseqid pident\" -num_alignments=100 2>&1");
}
else
{
	$result = shell_exec("/opt/ncbi-blast-2.7.1+/bin/blastn -query " . $path . " -db /var/www/BLASTdb2/vdl_flu_nt -outfmt \"6 sseqid pident\" -perc_identity 96 -num_alignments=100 2>&1");
}
